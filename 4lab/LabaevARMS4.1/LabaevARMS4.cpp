    ...
    do {
        ...
        case 1:
        {
            ...
            if (numOfChoise == 1) {
                ...
                cin >> N;
                for (int i = 1; i <= N; i++) {
                    newFactory.AddPerson(Randomization::getRanFIO(), Randomization::getRanAge(), Randomization::getRanSalary(), PersonalPost::PersonalPost::WORKER);
                    counterWorkers++;
                ...
                cin >> N;
                for (int i = 1; i <= N; i++) {
                    newFactory.AddPerson(Randomization::getRanFIO(), Randomization::getRanAge(), Randomization::getRanSalary(), PersonalPost::PersonalPost::ENGINEER);
                    counterEngineers++;
                    ...
                    for (int j = 1; j <= numberOfWorkersForEngineer; j++) {
                        AddedWorker++;
                        ((Engineer&)newFactory.GetPersonal(newFactory.getCapacityOfPersonals() - 1)).addWorker((Worker&)newFactory.GetPersonalByPost(PersonalPost::PersonalPost::WORKER, AddedWorker));
                    }
                }
            }
                ...
                cin >> N;
                for (int i = 1; i <= N; i++) {
                    newFactory.AddPerson(Randomization::getRanFIO(), Randomization::getRanAge(), Randomization::getRanSalary(), PersonalPost::PersonalPost::FOREMAN);
                    counterForemans++;
                    ...
                    for (int j = 1; j <= numberOfEngineersForForeman; j++) {
                        AddedEngineer++;
                        ((Foreman&)newFactory.GetPersonal(newFactory.getCapacityOfPersonals() - 1)).addEngineer((Engineer&)newFactory.GetPersonalByPost(PersonalPost::PersonalPost::ENGINEER, AddedEngineer));
                    }
                }
            }
                ...
                cin >> N;
                for (int i = 1; i <= N; i++) {
                    newFactory.AddPerson(Randomization::getRanFIO(), Randomization::getRanAge(), Randomization::getRanSalary(), PersonalPost::PersonalPost::MANAGER);
                    counterManagers++;
                    ...
                    for (int j = 1; j <= numberOfForemansForManager; j++) {
                        AddedForeman++;
                        ((Manager&)newFactory.GetPersonal(newFactory.getCapacityOfPersonals() - 1)).addForeman((Foreman&)newFactory.GetPersonalByPost(PersonalPost::PersonalPost::FOREMAN, AddedForeman));
                        ((Foreman&)newFactory.GetPersonalByPost(PersonalPost::PersonalPost::FOREMAN, AddedForeman)).setManager((Manager*)&newFactory.GetPersonalByPost(PersonalPost::PersonalPost::MANAGER, counterManagers));
                    }
                }
            }
            else {
        ...
        case 2:
            ...
            if (numOfChoise == 1) {
                ...
                cout << "This number is not in the database." << endl;
                    ...
                    newFactory.deleteById(numberOfPersonal, PersonalPost::PersonalPost::WORKER);
                }
            }
            else if (numOfChoise == 2) {
                ...
                if (numberOfPersonal > counterEngineers) {
                    ...
                    newFactory.deleteById(numberOfPersonal, PersonalPost::PersonalPost::ENGINEER);
                }
            }
            else if (numOfChoise == 3) {
                ...
                if (numberOfPersonal > counterForemans) {
                    ...
                    newFactory.deleteById(numberOfPersonal, PersonalPost::PersonalPost::FOREMAN);
                }
            }
            else if (numOfChoise == 4) {
                ...
                if (numberOfPersonal > counterManagers) {
                    ...
                    newFactory.deleteById(numberOfPersonal, PersonalPost::PersonalPost::MANAGER);
                }
            }
            else {
                cout << "1)Only 1 - 4!" << endl;
